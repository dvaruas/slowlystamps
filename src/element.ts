import { fetchImageURL } from "./urls";
import {
  StampCardClass,
  StampCardImageClass,
  StampCardNameClass,
...
export class StampElement {
  ...
  constructor(
    ...
    private readonly itemGroup: string,
  ...
  get element(): HTMLDivElement {
    ...
    this.e.innerHTML = format(elementInnerHTML, [
      StampCardImageClass,
      format(fetchImageURL, [this.slug]),
      this.slug,
      StampCardNameClass,
      this.name,
    ]);
  ...
  static fromJson(jsonElem: any): StampElement | null {
    ...
    let itemGroup = jsonElem["item_group"] as string | null;
    if (itemGroup == null) {
      return null;
    }
